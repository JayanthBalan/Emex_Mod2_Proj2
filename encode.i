...
# 30 "src/encode.c" 3 4
               stdout
# 30 "src/encode.c"
                     , "%s: Error reading width", "src/encode.c");
        return 0;
    }
    fprintf(
# 33 "src/encode.c" 3 4
...
# 37 "src/encode.c" 3 4
               stdout
# 37 "src/encode.c"
                     , "%s: Error reading height", "src/encode.c");
        return 0;
    }
    fprintf(
# 40 "src/encode.c" 3 4
...
# 61 "src/encode.c" 3 4
            stderr
# 61 "src/encode.c"
                  , "%s: Unable to open file %s\n", "src/encode.c", encInfo->src_image_fname);
...
# 72 "src/encode.c" 3 4
            stderr
# 72 "src/encode.c"
                  , "%s: Unable to open file %s\n", "src/encode.c", encInfo->secret_fname);
...
# 83 "src/encode.c" 3 4
            stderr
# 83 "src/encode.c"
                  , "%s: Unable to open file %s\n", "src/encode.c", encInfo->stego_image_fname);
...
static void cleanup_fp(EncodeInfo *encInfo) {
    if(encInfo->fptr_src_image != 
# 174 "src/encode.c" 3 4
                                 ((void *)0)
# 174 "src/encode.c"
                                     ) {
        fclose(encInfo->fptr_src_image);
        encInfo->fptr_src_image = 
# 176 "src/encode.c" 3 4
                                 ((void *)0)
# 176 "src/encode.c"
                                     ;
    }
    if(encInfo->fptr_secret != 
# 178 "src/encode.c" 3 4
                              ((void *)0)
# 178 "src/encode.c"
                                  ) {
        fclose(encInfo->fptr_secret);
        encInfo->fptr_secret = 
# 180 "src/encode.c" 3 4
                              ((void *)0)
# 180 "src/encode.c"
                                  ;
    }
    if(encInfo->fptr_stego_image != 
# 182 "src/encode.c" 3 4
                                   ((void *)0)
# 182 "src/encode.c"
                                       ) {
        fclose(encInfo->fptr_stego_image);
        encInfo->fptr_stego_image = 
# 184 "src/encode.c" 3 4
                                   ((void *)0)
# 184 "src/encode.c"
                                       ;
    }
    fprintf(
# 186 "src/encode.c" 3 4
           stdout
# 186 "src/encode.c"
...
# 195 "src/encode.c"
    ...
    if(check_capacity(encInfo) == e_failure) {
        fprintf(
# 198 "src/encode.c" 3 4
               stderr
# 198 "src/encode.c"
                     , "%s: File not suitable for encoding.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 202 "src/encode.c" 3 4
           stdout
# 202 "src/encode.c"
                 , "%s: File suitable for encoding.\n", "src/encode.c");

    if(copy_bmp_header(encInfo->fptr_src_image, encInfo->fptr_stego_image) == e_failure) {
        fprintf(
# 205 "src/encode.c" 3 4
               stderr
# 205 "src/encode.c"
                     , "%s: Failed to copy bmp header.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 209 "src/encode.c" 3 4
           stdout
# 209 "src/encode.c"
                 , "%s: BMP header duplication successful.\n", "src/encode.c");

    if(encode_magic_string("#*", encInfo) == e_failure) {
        fprintf(
# 212 "src/encode.c" 3 4
               stderr
# 212 "src/encode.c"
                     , "%s: Failed to encode magic string.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 216 "src/encode.c" 3 4
           stdout
# 216 "src/encode.c"
                 , "%s: Magic string encoding successful.\n", "src/encode.c");

    if(encode_secret_file_extn_size(encInfo->size_secret_file_extn, encInfo) == e_failure) {
        fprintf(
# 219 "src/encode.c" 3 4
               stderr
# 219 "src/encode.c"
                     , "%s: Failed to encode file extension size.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 223 "src/encode.c" 3 4
           stdout
# 223 "src/encode.c"
                 , "%s: File extension size encoding successful.\n", "src/encode.c");

    if(encode_secret_file_extn(encInfo->extn_secret_file, encInfo) == e_failure) {
        fprintf(
# 226 "src/encode.c" 3 4
               stderr
# 226 "src/encode.c"
                     , "%s: Failed to encode file extension.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 230 "src/encode.c" 3 4
           stdout
# 230 "src/encode.c"
                 , "%s: File extension encoding successful.\n", "src/encode.c");

    if(encode_secret_file_size(encInfo->size_secret_file, encInfo) == e_failure) {
        fprintf(
# 233 "src/encode.c" 3 4
               stderr
# 233 "src/encode.c"
                     , "%s: Failed to encode file size.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 237 "src/encode.c" 3 4
           stdout
# 237 "src/encode.c"
                 , "%s: File size encoding successful.\n", "src/encode.c");

    if(encode_secret_file_data(encInfo) == e_failure) {
        fprintf(
# 240 "src/encode.c" 3 4
               stderr
# 240 "src/encode.c"
                     , "%s: Failed to encode file data.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 244 "src/encode.c" 3 4
           stdout
# 244 "src/encode.c"
                 , "%s: File data encoding successful.\n", "src/encode.c");

    if(copy_remaining_img_data(encInfo->fptr_src_image, encInfo->fptr_stego_image) == e_failure) {
        fprintf(
# 247 "src/encode.c" 3 4
               stderr
# 247 "src/encode.c"
                     , "%s: Failed to duplicate remainder file data.\n", "src/encode.c");
        cleanup_fp(encInfo);
        return e_failure;
    }
    fprintf(
# 251 "src/encode.c" 3 4
           stdout
# 251 "src/encode.c"
                 , "%s: Remainder file data duplication successful.\n", "src/encode.c");
...
Status copy_remaining_img_data(FILE *fptr_src, FILE *fptr_dest) {
    char buffer[16];
    size_t bytes_read;
    while((bytes_read = fread(&buffer, 1, 16, fptr_src)) > 0) {
...
Status encode_secret_file_data(EncodeInfo *encInfo) {
    fseek(encInfo->fptr_secret, 0, 
# 269 "src/encode.c" 3 4
                                  0
# 269 "src/encode.c"
                                          );
    char data_buffer[16];
    ...
    size_t bytes_read;
    while((bytes_read = fread(data_buffer, 1, 16, encInfo->fptr_secret)) > 0) {
...
Status encode_secret_file_size(uint64_t file_size, EncodeInfo *encInfo) {
    size_t size = e_file_size_field*(1 * 8);
    uint8_t buffer[size];
    ...
    for(int8_t j = 0; j < e_file_size_field; j++) {
        if(encode_byte_to_lsb(file_size_byte[j], &buffer[(j*(1 * 8))]) == e_failure) {
            return e_failure;
        }
    }
...
Status encode_secret_file_extn_size(const uint extn_size, EncodeInfo *encInfo) {
    size_t size = e_file_extn_size_field*(1 * 8);
    uint8_t buffer[size];
    FILE *fptr_src_image = encInfo->fptr_src_image;
    FILE *fptr_stego_image = encInfo->fptr_stego_image;
    ...
    for(int8_t j = 0; j < e_file_extn_size_field; j++) {
        if(encode_byte_to_lsb(extn_size_byte[j], &buffer[(j*(1 * 8))]) == e_failure) {
            return e_failure;
        }
    }
    if(fwrite(buffer, 1, size, fptr_stego_image) != size) {
...
Status encode_data_to_image(const char *data, size_t size, FILE *fptr_src_image, FILE *fptr_stego_image) {
    ...
    for(size_t i = 0; i < size; i++) {
        if(fread(buffer, 1, (1 * 8), fptr_src_image) != (1 * 8)) {
            return e_failure;
        }
        if(encode_byte_to_lsb(data[i], buffer) == e_failure) {
            return e_failure;
        }
        if(fwrite(buffer, 1, (1 * 8), fptr_stego_image) != (1 * 8)) {
            return e_failure;
        }
    }
...
Status copy_bmp_header(FILE *fptr_src_image, FILE *fptr_dest_image) {
    fseek(fptr_src_image, 0, 
# 362 "src/encode.c" 3 4
                            0
# 362 "src/encode.c"
                                    );
    fseek(fptr_dest_image, 0, 
# 363 "src/encode.c" 3 4
                             0
# 363 "src/encode.c"
                                     );
    char header[54];

    size_t bytes_transferred = fread(header, 1, 54, fptr_src_image);
    if(bytes_transferred != 54) {
        return e_failure;
    }

    bytes_transferred = fwrite(header, 1, 54, fptr_dest_image);
    if(bytes_transferred != 54) {
        return e_failure;
    }
...
Status check_capacity(EncodeInfo *encInfo) {
    ...
    if(encInfo->image_capacity < ((encInfo->size_secret_file + e_magic_string_field +
        e_file_extn_size_field + e_file_size_field + encInfo->size_secret_file_extn)*(1 * 8))) {
        return e_failure;
    }
    return e_success;
}
